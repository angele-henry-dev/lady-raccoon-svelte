<div class="logo w-[50px] h-[40px] flex flex-row">
  <a href="/" title="Ouvre la page d'accueil" aria-label="Ouvre la page d'accueil de forabetter.tech" class="icon size-full block py-1 hover:bg-[var(--primary)]">
  ...
  <a href="/" title="Ouvre la page d'accueil" aria-label="Ouvre la page d'accueil de forabetter.tech" class="open-dyslexic uppercase hidden sm:block py-1 px-2 hover:text-[var(--background)] hover:bg-[var(--primary)]">forabetter.tech</a>
</div>
