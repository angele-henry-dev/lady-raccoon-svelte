...
<div class="logo flex flex-row">
  <a href="/" title="Homepage" aria-label="Go on homepage" class="icon flex items-center gap-5">
  ...
  <a href="/" title="Homepage" aria-label="Go on homepage" class="flex items-center gap-5">
