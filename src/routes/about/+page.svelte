...
<svelte:head>
  ...
  <meta property="og:title" content="À propos • La communauté tech bienveillante" />
  <meta property="og:description" content="Forabetter.tech, c’est une bulle d’entraide pour apprendre, échanger et grandir ensemble dans la tech. Fondée par Angele Henry." />
  <meta property="og:image" content="https://forabetter.tech/og-about.png" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://forabetter.tech/about" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="À propos de forabetter.tech" />
  <meta name="twitter:description" content="Une communauté tech inclusive et bienveillante, créée pour apprendre et s’entraider. Découvre l’histoire derrière le projet." />
  <meta name="twitter:image" content="https://forabetter.tech/og-about.png" />
  <link rel="canonical" href="https://forabetter.tech/about" />
</svelte:head>

<section class="max-w-3xl mx-auto px-4 py-16">
  <h1 class="text-4xl font-bold mb-8">À propos de forabetter.tech</h1>

  <p class="mb-6 text-lg">
    <strong>Un cocon tech pour apprendre, échanger et grandir ensemble.</strong>
  </p>

  <p class="mb-6">
    Salut ! Moi c’est <strong>Angele</strong>, développeuse passionnée depuis mes premiers pas sur Amstrad.
    J’ai traversé le monde de la tech en solo pendant longtemps… jusqu’à ce que je réalise qu’on avance bien plus vite (et plus heureux) quand on n’est pas seul·e.
  </p>
  ...
  <ul class="list-disc pl-6 space-y-2">
    ...
    <li><strong>Monter en compétences</strong>, ensemble</li>
  ...
  <ul class="list-disc pl-6 space-y-2">
    ...
    <li>Des <strong>outils gratuits</strong> pour les devs (comme un testeur de contraste WCAG)</li>
    <li>Des <strong>ebooks, formations et ressources</strong> créés avec amour</li>
